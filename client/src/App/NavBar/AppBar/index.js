...
export default function ButtonAppBar() {
  ...
  // === LINK IN NAVBAR
  const navLinkJSX = linkUser.map((r) => (
    <NavLink
      exact
      key={r.label}
      to={`${r.route}`}
